...
<body>
	...
	<table align="center">
		...
		<tr>
			<td align="center">4 修改</td>
		</tr>
	</table>

	<%
		//调用javabean后，获取id，查询显示此id的所有信息，然后修改提交
		...
		<table align="center">
			...
			<tr>
				...
				<td><input name="name" type="text" id="name"
					value="<%=rs.getString("name")%>" size="25" /></td>
			</tr>
			<tr>
				<td>出生</td>
				<td><input name="birDate" type="text" id="birDate"
					value="<%=rs.getString("birDate")%>" size="25" /></td>
			</tr>
			<tr>
				<td>性别</td>
