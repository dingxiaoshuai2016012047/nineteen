<%@ page contentType="text/html; charset=utf-8" language="java"
	...
	<%@page import="java.util.*,java.sql.*,com.nenu.stu.*,dataconn.StuAlter" %>
...
<body>
	...
	<form method="post" action="SearchOneStudent">
		<input type="text" name="main" placeholder="关键字（不要输入空格）" /> 
		<select		name="select">
			<option value="Sno">学生学号</option>
	...
	<caption>学生信息</caption>
		...
		<form method="post" action="AddOneStudent">
			<tr>
				<td><input name="Sno" type="text" placeholder="学生学号" /></td>
				<td><input name="Sname" type="text" placeholder="姓名" /></td>
				<td><input name="Sdate" type="text" placeholder="出生日期" /></td>
				<td><input name="Sclass" type="text" placeholder="班级" /></td>
				<td colspan="2"><input type="submit" value="新  增" /></td>
			</tr>
		</form>
		<%
				//定义四个变量
		...
		<tr>
			...
			<td><a href="stuEdit.jsp?Sno=<%=rs.getString("sid")%>">修改</a></td>
			<td><a href="DeleteOneStudent?Sno=<%=rs.getString("sid")%>">删除</a></td>
		</tr>
		<%
